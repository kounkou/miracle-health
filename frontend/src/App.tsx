...
export default function App() {
    ...
    const [accent, setAccent] = useState<AccentName>(() => {
        try {
            ...
            return stored === "blue" ? stored : "blue";
        } catch {
            return "blue";
        }
    });
    ...
    function handleLogin(token: string, email: string, expiresAt?: string, isAdmin?: boolean) {
        const s: SessionData = { token, email, expiresAt, isAdmin };
